    ...
    <footer className="border-t border-border py-12 px-6">
      <div className="max-w-7xl mx-auto">
        <div className="grid md:grid-cols-3 gap-10">
          ...
          <div>
            <p className="font-semibold text-foreground mb-4 text-sm">{tr("footer.nav_title")}</p>
            <nav className="flex flex-col gap-2 text-sm text-muted-foreground">
              <a href="#about" className="hover:text-foreground transition-colors">{tr("nav.about")}</a>
              <a href="#product" className="hover:text-foreground transition-colors">{tr("nav.product")}</a>
              <a href="#franchise" className="hover:text-foreground transition-colors">{tr("nav.franchise")}</a>
              <a href="#faq" className="hover:text-foreground transition-colors">{tr("nav.faq")}</a>
              <a href="#contact" className="hover:text-foreground transition-colors">{tr("nav.contact")}</a>
            </nav>
          </div>

          <div>
            <p className="font-semibold text-foreground mb-4 text-sm">{tr("footer.social_title")}</p>
