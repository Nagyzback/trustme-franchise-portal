  ...
  <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-16">
    ...
    <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
      ...
      >
        <a
          href="#contact"
          className="gradient-primary text-primary-foreground font-semibold text-lg px-8 py-4 rounded-[10px] shadow-button hover:opacity-90 transition-all hover:scale-[1.02]"
        >
          Стать партнёром
        </a>
        <a
          href="#about"
          className="text-foreground font-medium text-lg px-8 py-4 rounded-[10px] border border-border hover:bg-secondary transition-colors"
        >
          Узнать больше
        </a>
      </motion.div>
